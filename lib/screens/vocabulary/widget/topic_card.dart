...
class TopicCard extends StatefulWidget {
  final VocaTopic vocaTopic;
  const TopicCard(
      {super.key,
      required this.vocaTopic});
    ...
    return Container(
      ...
      child: Container(
        ...
        child:
          ...
          SizedBox(width: 50, height: 50, child: Image.asset(widget.vocaTopic.image)),
          Text(
          ...
          widget.vocaTopic.progress
              ? const ProgressStatus(progress: true)
              : const ProgressStatus(progress: false)
        ]),
      ),
    );
  }
