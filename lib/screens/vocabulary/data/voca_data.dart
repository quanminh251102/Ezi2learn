...
//Travel
  ...
  Vocabulary(
      ...
      spelling: '/ˈkɑː.ɡəʊ bəʊt/',
      meaning: 'Thuyền chở hàng'),
  Vocabulary(
      text: 'Delivery truck',
      image:
      ...
      spelling: '/dɪˈlɪv.ər.i ˌtrʌk/',
      meaning: 'Xe tải chở hàng'),
  Vocabulary(
      text: 'Garbage truck',
      image:
...
//Kitchen
  ...
  Vocabulary(
      ...
      spelling: '/ˌkɪtʃ.ənˈsɪŋk/',
      meaning: 'Bồn rửa chén'),
  Vocabulary(
      text: 'Pot',
      image:
...
//Flowers
  ...
  Vocabulary(
      ...
      spelling: '/ˈlæv.ɪn.dər/',
      meaning: 'Hoa oải hương'),
  Vocabulary(
      text: 'Lotus',
      image:
  ...
  Vocabulary(
      ...
      spelling: '/ˈsʌnˌflaʊər/',
      meaning: 'Hoa hướng dương'),
...
//Weathers
  ...
  Vocabulary(
      ...
      spelling: '/vɒlˈkeɪ.nəʊ ɪˈrʌp.ʃən/',
      meaning: 'Phun trào núi lửa'),
...
//Toys
  ...
  Vocabulary(
      ...
      spelling: '/ˌkʌd.əli ˈtɔɪ/',
      meaning: 'Đồ chơi nhồi bông'),
  Vocabulary(
      text: 'Abacus',
      image:
